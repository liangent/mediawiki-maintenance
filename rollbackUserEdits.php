...
class RollbackUserEdits extends PageMaintenance {
	...
	public function __construct() {
		...
		$this->addOption( 'group', 'User groups (explicit only) to skip, use pipe as separator' );
		$this->addOption( 'user', 'Users (no anons) to skip, use pipe as separator' );
		$this->addOption( 'ip', 'IP (ranges) to skip, use pipe as separator' );
	}
